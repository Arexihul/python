...
result = df.groupby("Semt").get_group("Tuzla").groupby("Departman").get_group("Muhasebe")
result = df.groupby("Semt").get_group("Kadıköy").groupby("Maaş").get_group(5000)
