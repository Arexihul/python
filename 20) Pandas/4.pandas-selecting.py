...
df.drop("Column5", axis = 1, inplace = True)    # Bu methodla column5 silinir
# inplace True olursa değişiklik orjinal df için olur, True olmazsa değişiklik kopya için olur
print(df)
print(result)