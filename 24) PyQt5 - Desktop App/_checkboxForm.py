...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(561, 432)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.btnHobilerSecilenleriAl = QtWidgets.QPushButton(self.centralwidget)
        self.btnHobilerSecilenleriAl.setGeometry(QtCore.QRect(70, 230, 111, 41))
        ...
        self.lblResultHobiler.setGeometry(QtCore.QRect(30, 280, 191, 91))
        ...
        self.groupHobiler.setGeometry(QtCore.QRect(30, 30, 211, 191))
        self.groupHobiler.setObjectName("groupHobiler")
        self.widget = QtWidgets.QWidget(self.groupHobiler)
        self.widget.setGeometry(QtCore.QRect(40, 40, 101, 121))
        ...
        self.groupDersler.setGeometry(QtCore.QRect(320, 30, 211, 191))
        self.groupDersler.setObjectName("groupDersler")
        self.layoutWidget = QtWidgets.QWidget(self.groupDersler)
        self.layoutWidget.setGeometry(QtCore.QRect(40, 40, 101, 121))
        ...
        self.btnDerslerSecilenleriAl.setGeometry(QtCore.QRect(360, 230, 111, 41))
        ...
        self.lblResultDersler.setGeometry(QtCore.QRect(320, 280, 191, 91))
